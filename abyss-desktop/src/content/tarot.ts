/* 12 Major Arcana cards flipped per betting outcome. */

export type TarotTier = 'big-win' | 'small-win' | 'push' | 'small-loss' | 'big-loss' | 'cursed' | 'special';
...
export function pickTarotCard(delta: number, cursed: boolean): TarotCard {
